...
define(['module/Nova.swipable/1.0.2/swipable'], function() {return factory.apply(root, arguments)});
} else {
root['Loadmore'] = factory.apply(root);
}
})(this, function(Swipable) {
Swipable = Swipable || this.Swipable;
